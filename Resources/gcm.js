...
(function (service) {
	...
	navObj = serviceIntent.hasExtra('navObj') ? serviceIntent.getStringExtra('navObj') : '',
	navId = serviceIntent.hasExtra('navId') ? serviceIntent.getStringExtra('navId') : '',
	nid = serviceIntent.hasExtra('notification_id') ? serviceIntent.getStringExtra('notification_id') : '',
	...
	launcherIntent.putExtra("navObj", navObj);
	launcherIntent.putExtra("navId", navId);
	launcherIntent.putExtra("nid", nid);
